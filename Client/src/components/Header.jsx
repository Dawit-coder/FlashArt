...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:ex-7xl sm:max-w-[590px] mx-autto mt-10 text-center'>Turn text to <span className='text-[#E69414]'
      initial={{opacity: 0}}
      animate={{opacity:1}}
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer'
      ...
      className='mt-2 text-neutral-600'>Generated images from FlashArt</motion.p>
    </motion.div>
  )
}
